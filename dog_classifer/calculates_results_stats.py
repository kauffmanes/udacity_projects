...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        label, c_label, is_match, is_dog, c_is_dog = results_dic[key]
                
        # breeds match
        if is_match == 1:
            results_stats_dic['n_match'] += 1
        
            # breeds match and classified as a dog - counts correct breed
            if is_dog == 1:
                results_stats_dic['n_correct_breed'] += 1
                
        # if its a dog, regardless of match
        if is_dog == 1:
            
            results_stats_dic['n_dogs_img'] += 1
                
            # how many dogs classified as dogs
            if c_is_dog == 1:
